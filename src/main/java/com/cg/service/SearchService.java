...
public class SearchService {
	...
	public List<RestaurantDto> searchRestaurants(String keyword) {
		List<Restaurant> found = restaurantRepository.findByRestaurantNameContainingIgnoreCase(keyword);
	...
	public List<MenuItemDto> searchMenuItems(String keyword) {
		List<MenuItem> found = menuItemRepository.findByItemNameContainingIgnoreCase(keyword);
