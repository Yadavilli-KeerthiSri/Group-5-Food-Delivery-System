...
public class GlobalExceptionHandler {
	...
	/**
	 * Helper to determine where to send the user back to. It uses the 'Referer'
	 * header to go back to the previous list (Menu or Restaurant).
	 */
	...
	public String handleFKViolation(DataIntegrityViolationException ex, HttpServletRequest request,
