...
class AdminMenuItemControllerTest {
	...
	// with flash error
	@Test
	@DisplayName("DELETE /admin/menu-items/delete/{id} throws IllegalStateException → redirect back with error")
	void delete_whenBusinessRuleViolation_shouldRedirectBackWithFlash() throws Exception {
		...
		mockMvc.perform(delete("/admin/menu-items/delete/5").header(HttpHeaders.REFERER, "/admin/menu-items"))
