...
class UserProfileControllerTest {
	...
	@Test
	@DisplayName("PUT /user/profile/update → redirects to /user/profile and calls register()")
	void update_shouldRedirectAndCallRegister() throws Exception {
		...
		mvc.perform(put("/user/profile/update")
	...
	@Test
	@DisplayName("PUT /user/profile/update (different principal) → redirects to /user/profile and calls register()")
	void update_withDifferentUser_shouldRedirect() throws Exception {
		...
		mvc.perform(put("/user/profile/update").param("lastName", "Daggu").principal(auth))
