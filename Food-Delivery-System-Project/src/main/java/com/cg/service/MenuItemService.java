...
public class MenuItemService implements IMenuItemService {
	...
	public MenuItemDto add(MenuItemDto dto) {
		MenuItem entity = MenuItemMapper.fromCreateDto(dto,
	...
	public MenuItemDto update(MenuItemDto dto) {
		...
		MenuItemMapper.applyUpdate(dto, existing, restId -> restaurantRepository.findById(restId).orElse(null));
	...
	public List<MenuItemDto> getByRestaurant(Long restaurantId) {
		return menuItemRepository.findByRestaurantRestaurantId(restaurantId).stream().map(MenuItemMapper::toDto)
