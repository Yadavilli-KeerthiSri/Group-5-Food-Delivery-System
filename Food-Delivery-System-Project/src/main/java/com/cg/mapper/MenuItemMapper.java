...
public final class MenuItemMapper {
	...
	// ===== Create =====
	public static MenuItem fromCreateDto(MenuItemDto dto, Function<Long, Restaurant> restaurantResolver) {
		if (dto == null)
			return null;
	...
	// ===== Update =====
	public static void applyUpdate(MenuItemDto dto, MenuItem target, Function<Long, Restaurant> restaurantResolver) {
