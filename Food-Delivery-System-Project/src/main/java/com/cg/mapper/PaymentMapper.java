...
public final class PaymentMapper {
	...
	// ===== Create =====
	public static Payment fromCreateDto(PaymentDto dto, Function<Long, Order> orderResolver) {
		if (dto == null)
			return null;
	...
	// ===== Update =====
	public static void applyUpdate(PaymentDto dto, Payment target, Function<Long, Order> orderResolver) {
